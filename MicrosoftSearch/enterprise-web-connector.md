...
The authentication method you choose will apply for all websites you have provided to index in a connection. To authenticate and sync content from websites, choose **one of the four** supported methods:<br>
...
The Enterprise Websites cloud connector supports search permissions visible to **Everyone** only. Indexed data will appear in the search results for all users in your organization.
